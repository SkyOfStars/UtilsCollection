...
import static com.cy.utils.view.leanback.ItemAlignmentFacet.ITEM_ALIGN_OFFSET_PERCENT_DISABLED;
...
class ItemAlignmentFacetHelper {
    ...
    static int getAlignmentPosition(View itemView, ItemAlignmentFacet.ItemAlignmentDef facet,
                                    int orientation) {
        TestLayoutManager.LayoutParams p = (TestLayoutManager.LayoutParams) itemView.getLayoutParams();
        View view = itemView;
        if (facet.mViewId != 0) {
